...
class Ui_MainWindow(object):
        ...
        def openWindow(self):
                ...
                self.ui = Registro.Ui_SecondWindow(self.txtusuario.text(), self.lineEdit_2.text())
        ...
        def setupUi(self, MainWindow):
                ...
                icon = QtGui.QIcon()
                icon.addPixmap(QtGui.QPixmap("imagenes/iniciar-sesion.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        "background-image: url(imagenes/usuario.png);")
                ...
                self.btningresar = QtWidgets.QPushButton(self.frame, clicked = lambda: self.openWindow())
